...
<?php
 ...
 $sq1="INSERT INTO `mohammed`.`class` (`ClassName`)
         VALUES (
           '$class_name'
...
<?php
 ...
 $name=$_POST['TermS_id'];
  $title1=$_POST['Term_name'];
 
   $loc_brith1=$_POST['classid'];
    
  
 $sq="INSERT INTO `mohammed`.`term_study` (`Term_name`,`classid`)
         VALUES (
          '$title1',
...
<div class="container" style="margin-top:-30px" >
    <div class="row">
    	...
    	<section>
            ...
            <h2>
              شاشة ادخال المستويات والفصول الدراسية</h2>
            </br>
             ...
             <div class="row">
                            <div class="col-md-6">
                                <label for="id_document">اسم المستوى الدراسي</label>
                                <input type="text" class="form-control"  name="ClassName" placeholder="ادخل المستوى الدراسي">
                            </div>
