          ...
          if (c.isVideo) {
            if (mejs.MediaFeatures.hasTouch) c.$media.bind('touchstart', function () {
              ...
              c.container.bind('mouseenter mouseover', function () {
                ...
                c.controlsEnabled && !c.media.paused && !c.options.alwaysShowControls && c.startControlsTimer(1000)
              })
            }
...
(function (f) {
  ...
  f.extend(MediaElementPlayer.prototype, {
    ...
    setupSlides: function (a) {
      this.slides = a;
      this.slides.entries.imgs = [
        this.slides.entries.text.length
      ];
      this.showSlide(0)
    },
  ...
  f.extend(MediaElementPlayer.prototype, {
    ...
    renderContextMenu: function (a, b) {
      for (var c = this, e = '', d = c.options.contextMenuItems, g = 0, k = d.length; g < k; g++) if (d[g].isSeparator) e += '<div class="mejs-contextmenu-separator"></div>';
        ...
        var j = d[g].render(c);
        if (j != null) e += '<div class="mejs-contextmenu-item" data-itemindex="' + g + '" id="element-' + Math.random() * 1000000 + '">' + j + '</div>'
      }
